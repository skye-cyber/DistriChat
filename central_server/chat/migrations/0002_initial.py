...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='chatroom',
            name='node',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='nodes.node'),
        ),
        migrations.AddField(
            model_name='message',
            name='room',
        ...
        migrations.AddField(
            ...
            name='source_node',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sync_sources', to='nodes.node'),
        ),
        migrations.AddField(
            model_name='syncsession',
            name='target_node',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sync_targets', to='nodes.node'),
        ),
        migrations.AddField(
            model_name='messagesynclog',
            name='sync_session',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='synced_messages', to='chat.syncsession'),
        ),
        migrations.AddField(
            model_name='systemlog',
            name='node',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='nodes.node'),
        ),
        migrations.AddField(
            model_name='systemlog',
            name='user',
